...
const Preferences = () => {
  ...
  <button
    type="button"
    onClick={openModal}
    className="rounded-full bg-gray-200 p-1 text-black hover:bg-gray-100 hover:text-sky-600"
    id="preferences"
  >
              ...
              <div className="flex flex-wrap gap-4 pb-4">
                {sportsData.map((sport: any) => (
                    <div key={sport.id}>
                        ...
                        />
                        <span className="font-medium text-black"> {sport.name}</span>
                  </div>
                ))}
              </div>
              <hr/>
              <p className="mb-3 pt-2 text-xl font-bold text-black">Teams</p>
